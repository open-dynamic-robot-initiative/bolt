/**
 * @file dgm_bolt_humanoid.hpp
 * @license License BSD-3-Clause
 * @copyright Copyright (c) 2022, New York University and Max Planck
 * Gesellshaft.
 */
...
namespace bolt
{
class DGMBoltHumanoid : public dynamic_graph_manager::DynamicGraphManager
{
public:
    /**
...
private:
     ...
     */
    Eigen::Vector9d ctrl_joint_torques_;
     ...
     * the next jont index.
     */
    Eigen::Vector9d zero_to_index_angle_from_file_;
};
